...
public class ChoicePanel extends JPanel{
	...
	public void updateChoicePanel() {
		...
		music.addActionListener(e -> this.frame.setVisibleGame());
		this.add(music);
		...
		countries.addActionListener(e -> this.frame.setVisibleGame());
		this.add(countries);
		...
		animals.addActionListener(e -> this.frame.setVisibleGame());
		this.add(animals);
		...
		foods.addActionListener(e -> this.frame.setVisibleGame());
		this.add(foods);
		...
		objects.addActionListener(e -> this.frame.setVisibleGame());
		this.add(objects);
		...
		sports.addActionListener(e -> this.frame.setVisibleGame());
		this.add(sports);
		...
		art.addActionListener(e -> this.frame.setVisibleGame());
		this.add(art);
